# Emulator for the [HTTP JSON config API](https://homie-esp8266.readme.io/docs/http-json-api) of the [Homie for ESP8266](https://github.com/marvinroger/homie-esp8266)
